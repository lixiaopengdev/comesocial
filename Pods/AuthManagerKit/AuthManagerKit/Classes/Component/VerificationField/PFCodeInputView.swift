...
class PFCodeInputView: UIView {
    ...
    private func setup() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(textChanged(notify:)), name: UITextField.textDidChangeNotification, object: textField)
        NotificationCenter.default.addObserver(self, selector: #selector(beginEditText(notify:)), name: UITextField.textDidBeginEditingNotification, object: textField)
        NotificationCenter.default.addObserver(self, selector: #selector(endEditText(notify:)), name: UITextField.textDidEndEditingNotification, object: textField)
