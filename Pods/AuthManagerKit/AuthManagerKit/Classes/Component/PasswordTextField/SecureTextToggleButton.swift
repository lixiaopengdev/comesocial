...
open class SecureTextToggleButton: UIButton {
    ...
    open var showSecureTextImage:UIImage = UIImage.bundleForImage(named: "visibility_on") ?? .init() {
    ...
    open var hideSecureTextImage:UIImage = UIImage.bundleForImage(named: "visibility_off") ?? .init()
    ...
    /**
     ...
     - returns:
     */
    public convenience init(showSecureTextImage:UIImage = UIImage.bundleForImage(named:"visibility_on") ?? .init() , hideSecureTextImage:UIImage = UIImage.bundleForImage(named:"visibility_off") ?? .init() , imageTint:UIColor = UIColor.gray)
    {
