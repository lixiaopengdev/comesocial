...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CSAccountManager/CSAccountManager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSBaseView/CSBaseView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSCommon/CSCommon.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSFileKit/CSFileKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSFriendsModule/CSFriendsModule.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSImageKit/CSImageKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSListView/CSListView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSLogger/CSLogger.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSMeModule/CSMeModule.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CSPermission/CSPermission.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSRobotView/CSRobotView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSRouter/CSRouter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSTracker/CSTracker.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSUtilities/CSUtilities.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CSWebsocket/CSWebsocket.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ComeSocialRTCService/ComeSocialRTCService.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ComeSocialRootModule/ComeSocialRootModule.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JSEngineKit/JSEngineKit.framework"
  ...
  install_framework "${PODS_ROOT}/WhisperDiarization/WhisperDiarization/Frameworks/AggClustering.framework"
  install_framework "${PODS_ROOT}/WhisperDiarization/WhisperDiarization/Frameworks/whisperxx.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/come_social_media_tools_ios/come_social_media_tools_ios.framework"
