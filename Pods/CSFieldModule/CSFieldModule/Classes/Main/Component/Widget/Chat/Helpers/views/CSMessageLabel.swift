...
open class CSMessageLabel : UILabel {
    ...
    */
    ...
    fileprivate lazy var displayLink : CADisplayLink? = {
        var instance = CADisplayLink(target: self, selector: #selector(CSMessageLabel.animateProgress(_:)))
    ...
    fileprivate func defaultAttributes() -> [NSAttributedString.Key : Any]? {
        ...
        return [.paragraphStyle : paragraph, .font : font as Any, .foregroundColor : textColor as Any, .ligature : NSNumber(value: 0 as Int), .kern : NSNumber(value: 0.0 as Float)]
    }
